...
edge_dists_by_level = msgpack.unpack(open("out/hnsw/edge_dists_by_level.msgpack", "rb"), strict_map_key=False)
...
plt.tight_layout()
plt.savefig("out/hnsw/edge_dists_by_level.webp", format='webp', bbox_inches='tight', dpi=150)
print("Rendered plot")
